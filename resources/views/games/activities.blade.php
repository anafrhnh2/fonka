        ...
        @else
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-4xl px-4">
                @foreach($activities as $activity)
                    <a href="{{ route('games.menu', $activity->id) }}" class="group bg-white rounded-3xl p-6 shadow-lg border-b-8 border-indigo-200 hover:border-indigo-400 hover:scale-105 transition-all flex flex-col items-center">
